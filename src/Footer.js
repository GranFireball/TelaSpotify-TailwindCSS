import { Repeat, Shuffle, SkipForward, SkipBack, Play, Mic2, LayoutList, Laptop2, Volume, Maximize2 } from 'lucide-react';
    ...
    return (
        <footer className="bg-zinc-900 border-t border-zinc-700 p-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
                <img src={imgPlaylist} alt="Imagem Álbum" width={56} height={56} />
